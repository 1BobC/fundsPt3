...
//exercis not completed since I could not import images! Will come back to this exercise

//Using return values
let myText = 'The weather is cold';
let newString = myText.replace('cold', 'warm');
console.log(myText);
document.getElementById('bob1').innerHTML = `The old text is: ${myText}`;
console.log(newString);
document.getElementById('bob2').innerHTML = `The new text is: ${newString}`;

//Create a Function Library see indexFL html and associated files 
